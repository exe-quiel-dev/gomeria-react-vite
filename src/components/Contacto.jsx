...
const Contacto = () => {
  ...
  return (
    <div className='container mx-auto grid grid-cols-1 md:grid-cols-2 items-center py-14 lg:py-0'>
      <div className='w-4/5 lg:w-3/4 justify-self-center hidden md:block' data-aos='fade-left' data-aos-offset={0}>
        <img src={contactImg} alt='imagen de cubiertas de auto' className='w-full' />
      </div>
      <div className='w-1/2 justify-self-center' data-aos='zoom-in' data-aos-offset={0}>
