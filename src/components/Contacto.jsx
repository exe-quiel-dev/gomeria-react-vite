...
const Contacto = () => {
  ...
  return (
    <div className='container mx-auto grid grid-cols-1 md:grid-cols-2 items-center'>
      <div className='w-1/2 justify-self-center hidden md:block' data-aos='fade-left' data-aos-offset={200}>
        <img src={contactImg} alt='imagen de ruedas de auto' className='w-full' />
      </div>
      <div className='w-1/2 justify-self-center' data-aos='zoom-in' data-aos-offset={200}>
