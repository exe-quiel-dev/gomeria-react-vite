    ...
    <>
      <section className='grid grid-cols-1 lg:grid-cols-2 items-center bg-gray-200 py-14 lg:py-0' id='mision_vision'>
        <div className='flex flex-col items-center'>
          <div className='my-5 w-2/3 lg:w-1/2 justify-self-center p-5 md:p-0' data-aos='slide-right' data-aos-offset={50}>
        ...
        <div className='flex flex-col items-center'>
          <div className='my-5 w-2/3 lg:w-1/2 justify-self-center p-5 md:p-0' data-aos='slide-left' data-aos-offset={50}>
