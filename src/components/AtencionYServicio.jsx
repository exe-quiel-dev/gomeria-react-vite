    ...
    <>
      ...
      <Parallax strength={-400} bgImage={bgImg}>    
        <div className="flex flex-col md:flex-row items-center justify-center gap-5 p-10 md:p-20 text-center">
          <div className="p-5 bg-white w-4/5 h-auto md:h-60 md:w-2/3 flex flex-col justify-center items-center" data-aos="fade-up-right">
          ...
          <div className="p-5 bg-white w-4/5 h-auto md:h-60 md:w-2/3 flex flex-col justify-center items-center" data-aos="fade-up-left">
