...
const AtencionYServicio = () => {
  ...
  return (
    <>
      <section className=' bg_atencion_servicio grid grid-cols-1 items-center' id='atencion_servicio'>
        <div className="flex flex-col md:flex-row items-center justify-center gap-5 p-0 md:p-10 text-center">
          <div className="p-5 bg-white w-4/5 h-auto md:h-60 md:w-2/3 flex flex-col justify-center items-center" data-aos='fade-right' data-aos-offset={200}>
          ...
          <div className="p-5 bg-white w-4/5 h-auto md:h-60 md:w-2/3 flex flex-col justify-center items-center" data-aos='fade-left' data-aos-offset={200}>
